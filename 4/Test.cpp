...
int main(int argc, char *argv[]){
    ...
    aoc2021::ProblemRunner::RegisterProblem<aoc2021::Problem4>(problemNum);
    if (aoc2021::ProblemRunner::Run(problemNum, example_path.u8string()))
    {
        if (aoc2021::ProblemRunner::GetResult(1) != 4512) return EXIT_FAILURE;
        if (aoc2021::ProblemRunner::GetResult(2) != 1924) return EXIT_FAILURE;

        if (aoc2021::ProblemRunner::Run(problemNum, input_path.u8string()))
        {
            if (aoc2021::ProblemRunner::GetResult(1) != 58412) return EXIT_FAILURE;
            if (aoc2021::ProblemRunner::GetResult(2) != 10030) return EXIT_FAILURE;
            return EXIT_SUCCESS;
        }
    }
